      ...
      <tbody>
        ...
        <?php
                            ...
                            $res  = mysqli_query($conn, $sql);
                                ...
                                ?>
                                <tr>
                                    <th scope="row"><?php  echo $data['compname'];?></th>
                                    <td><img src="admin/uploads/<?= $data['image']?>" width="150" height="150"></td>
                                    <td><?php  echo $data['descp'];?></td>
                                    <td><?php  echo $data['dates'];?></td>
                                    <td><?php  echo $data['salary'];?> </td> 
                                   
                                   
                              <td><a href="<?php  echo $data['url'];?>"><button class='btn btn-success'>Register Now</button></a></td>
