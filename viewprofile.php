    ...
    <div class="row" style="margin-top:100px; margin-left:85px;">
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            <img src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="avatar"
      ...
      if(mysqli_num_rows($res) > 0){
        while($data = mysqli_fetch_array($res)){
          ...
          ?>
            <h5 class="my-3"><?= $data['reg_name']?></h5>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?= $data['reg_name']?></p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0"><?= $data['college']?></p>
              </div>
            </div>
            <hr>
            <div class="row">
